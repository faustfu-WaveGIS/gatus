...
export default {
  ...
  computed: {
    logo() {
      return window.config && window.config.logo && window.config.logo !== '' ? window.config.logo : "";
    },
    header() {
      return window.config && window.config.header && window.config.header !== 'Health Status' ? window.config.header : "Health Status";
    },
    link() {
      return window.config && window.config.link && window.config.link !== '' ? window.config.link : null;
    },
    buttons() {
